...
N_min = int(2)
Epsilon = float(50) #in kilometers
    ...
    while True and nn == '1':
        ...
        while True and n_ligacoes < N_min:
            ...
            if viagem != A2:
                ...
                distance = get_distance(float(viagem[5]), float(viagem[7]), float(A2[5]), float(A2[7]))
                if distance <= Epsilon:
                ...
                while True and mmm == 0:
                    ...
                    if n_linha > n_viagens_cluster_analizadas:
                        ...
                        while True:
                            ...
                            distance = get_distance(float(A_cluster[5]), float(A_cluster[7]), float(A2[5]), float(A2[7]))
    ...
    while True and nn == '1':
        ...
        while True and n_ligacoes < N_min:
            ...
            if viagem != A2:
                ...
                distance = get_distance(float(viagem[6]), float(viagem[8]), float(A2[6]), float(A2[8]))
                ...
                while True and mmm == 0:
                    ...
                    if n_linha > n_viagens_cluster_analizadas:
                        ...
                        while True:
                            ...
                            distance = get_distance(float(A_cluster[6]), float(A_cluster[8]), float(A2[6]), float(A2[8]))
                            if distance <= Epsilon  and distance != float(0):
                                # estão esta viagem faz parte do cluster
                                n_viagens_em_cluster = n_viagens_em_cluster + 1
                                # vamos escrever no ficheiro
